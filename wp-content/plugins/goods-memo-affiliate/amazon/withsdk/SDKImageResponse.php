...
/**
 * Description of SDKImageResponse
 *
 * @author Goods Memo
 */
class SDKImageResponse {

	public static function makeImageItem(\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\Item $searchItem): ImageItem {

		$imageItem = new ImageItem ();

		if ($searchItem->getImages () == NULL or $searchItem->getImages ()->getPrimary () == NULL) {
			return $imageItem;
		}
		...
		if ($primaryImages->getMedium () != NULL) {
			...
			SDKImageResponse::setImageInfoTo ( $imageItem, $imageSize );
	...
	private static function setImageInfoTo(ImageItem &$imageItem, \Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ImageSize $imageSize) {
