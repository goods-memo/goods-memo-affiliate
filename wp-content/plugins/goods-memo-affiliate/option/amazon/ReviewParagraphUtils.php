...
class ReviewParagraphUtils {
	...
	const STRING_TO_DELETE_JSON_ARRAY_ID = AmazonSettingSection::ID_PREFIX . "_string_to_delete_json_array_id";
	const STRING_TO_BREAK_JSON_OBJECT_ID = AmazonSettingSection::ID_PREFIX . "_string_to_break_json_object_id";
